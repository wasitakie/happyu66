                        ...
                        <div class="row g-3">
                            <div class="col">
                                ...
                                <div class="form-check">
                                    <label type="text" for="formGroupExampleInput" class="form-label">มหาวิทยาลัยราชภัฏศรีสะเกษ</label>
                        ...
                        <div class="row g-3">
                            <div class="col">
                                ...
                                <select class="form-select a2" name="a2" aria-label="Default select example" id="a2">
                                    ...
                                    <option value="3.คณะบริหารธุรกิจและการบัญชี">3. คณะบริหารธุรกิจและการบัญชี</option>
                                    <option value="4.คณะมนุษยศาสตร์และสังคมศาสตร์">4. คณะมนุษยศาสตร์และสังคมศาสตร์</option>
                                    <option value="5.วิทยาลัยกฏหมายและการปกครอง">5. วิทยาลัยกฏหมายและการปกครอง</option>
