                        ...
                        <div class="row g-3">
                            <div class="col">
                                ...
                                <select class="form-select a2" name="a2" aria-label="Default select example" id="a2">
                                    ...
                                    <option value="2.มนุษยศาสตร์และสังคมศาสตร์">2. มนุษยศาสตร์และสังคมศาสตร์</option>
                                    <option value="3.วิทยาศาสตร์และเทคโนโลยี">3. วิทยาศาสตร์และเทคโนโลยี</option>
                                    <option value="4.วิทยาการจัดการ">4. วิทยาการจัดการ</option>
                                    <option value="5.วิศวกรรมศาสตร์และเทคโนโลยีอุตสาหกรรม">5. วิศวกรรมศาสตร์และเทคโนโลยีอุตสาหกรรม</option>
                                    <option value="6.วิทยาลัยการดนตรี">6. วิทยาลัยการดนตรี</option>
                                    <option value="7.บัณฑิตวิทยาลัย">7. บัณฑิตวิทยาลัย</option>
                                    <option value="8.โรงเรียนสาธิตมหาวิทยาลัยราชภัฏบ้านสมเด็จเจ้าพระยา ">8. โรงเรียนสาธิตมหาวิทยาลัยราชภัฏบ้านสมเด็จเจ้าพระยา </option>
                                    <option value="9.สำนักงานอธิการบดี">9. สำนักงานอธิการบดี</option>
                                    <option value="10.สำนักประชาสัมพันธ์และสารสนเทศ">10. สำนักประชาสัมพันธ์และสารสนเทศ</option>
                                    <option value="11.สำนักวิทยบริการและเทคโนโลยีสารสนเทศ ">11. สำนักวิทยบริการและเทคโนโลยีสารสนเทศ </option>
                                    <option value="12.สำนักวิเทศสัมพันธ์และเครือข่ายอาเซียน">12. สำนักวิเทศสัมพันธ์และเครือข่ายอาเซียน</option>
                                    <option value="13.สำนักศิลปะและวัฒนธรรม">13. สำนักศิลปะและวัฒนธรรม</option>
                                    <option value="14.สำนักส่งเสริมวิชาการและงานทะเบียน">14. สำนักส่งเสริมวิชาการและงานทะเบียน</option>
                                    <option value="15.หน่วยตรวจสอบภายใน">15. หน่วยตรวจสอบภายใน</option>
                                    <option value="16.ศูนย์การศึกษาอู่ทองทวารวดี">16. ศูนย์การศึกษาอู่ทองทวารวดี</option>
                                    <option value="17.สถาบันวิจัยและพัฒนา">17. สถาบันวิจัยและพัฒนา</option>
                                    <option value="18.สำนักกิจการนักศึกษา">18. สำนักกิจการนักศึกษา</option>
                                    <option value="19.สำนักคอมพิวเตอร์">19. สำนักคอมพิวเตอร์</option>
                                    <option value="20.สำนักงานสภามหาวิทยาลัย">20. สำนักงานสภามหาวิทยาลัย</option>
                                </select>
