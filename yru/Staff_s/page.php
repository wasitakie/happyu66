                        ...
                        <div class="row g-3">
                            <div class="col">
                                ...
                                <select class="form-select a2" name="a2" aria-label="Default select example" id="a2">
                                    ...
                                    <option value="3.คณะวิทยาศาสตร์เทคโนโลยีและการเกษตร">3. คณะวิทยาศาสตร์เทคโนโลยีและการเกษตร</option>
                                    <option value="4.คณะวิทยาการจัดการ">4. คณะวิทยาการจัดการ</option>
                                    <option value="5.สถาบันวิจัยและพัฒนาชายแดนใต้">5. สถาบันวิจัยและพัฒนาชายแดนใต้</option>
                                    <option value="6.คสถาบันพัฒนาครูและบุคลลากรทางการศึกษาชายแดนใต้">6. คสถาบันพัฒนาครูและบุคลลากรทางการศึกษาชายแดนใต้</option>
                                    <option value="7.สำนักงานอธิการบดี">7. สำนักงานอธิการบดี</option>
                                    <option value="8.ศูนย์งานในมหาวิทยาลัย">8. ศูนย์งานในมหาวิทยาลัย</option>
