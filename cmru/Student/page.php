                        ...
                        <div class="row g-3">
                            <div class="col">
                                ...
                                <div class="form-check">
                                    <label type="text" for="formGroupExampleInput" class="form-label"> มหาวิทยาลัยราชภัฏเชียงใหม่</label>
                        ...
                        <div class="row g-3">
                            <div class="col">
                                ...
                                <select class="form-select a2" name="a2" aria-label="Default select example" id="a2">
                                    ...
                                    <option value="2.เทคโนโลยีการเกษตร">2. เทคโนโลยีการเกษตร</option>
                                    ...
                                    <option value="8.วิทยาลัยแม่ฮ่องสอน">8. วิทยาลัยแม่ฮ่องสอน</option>
                                    <option value="9.บัณฑิตวิทยาลัย">9. บัณฑิตวิทยาลัย</option>
                                    <option value="10.คณะอื่นๆภายในมหาวิทยาลัย">10. คณะอื่นๆภายในมหาวิทยาลัย</option>
