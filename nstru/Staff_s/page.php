                        ...
                        <div class="row g-3">
                            <div class="col">
                                ...
                                <select class="form-select a2" name="a2" aria-label="Default select example" id="a2">
                                    ...
                                    <option value="2.คณะวิทยาการจัดการ">2. คณะวิทยาการจัดการ</option>
                                    <option value="3.คณะมนุษยศาสตร์และสังคมศาสตร์">3. คณะมนุษยศาสตร์และสังคมศาสตร์</option>
                                    <option value="4.คณะเทคโนโลยีอุตสาหกรรม">4. คณะเทคโนโลยีอุตสาหกรรม</option>
                                    <option value="5.คณะครุศาสตร์">5. คณะครุศาสตร์</option>
                                    <option value="6.บัณฑิตวิทยาลัย">6. บัณฑิตวิทยาลัย</option>
                                    <option value="7.สำนักอธิการบดี">7. สำนักอธิการบดี</option>
                                    <option value="8.สำนักวิทยบริการและเทคโนโลยีสารสนเทศ">8. สำนักวิทยบริการและเทคโนโลยีสารสนเทศ</option>
                                    <option value="9.สำนักส่งเสริมวิชาการและงานทะเบียน">9. สำนักส่งเสริมวิชาการและงานทะเบียน</option>
                                    <option value="10.สถาบันวิจัยและพัฒนา">10. สถาบันวิจัยและพัฒนา</option>
                                    <option value="11.ตรวจสอบภายใน">11. ตรวจสอบภายใน</option>
                                    <option value="12.โครงการจัดตั้งศูนย์วัฒนธรรม">12. โครงการจัดตั้งศูนย์วัฒนธรรม</option>
                                    <option value="13.หน่วยงานอื่นๆในมหาวิทยาลัย">13. หน่วยงานอื่นๆในมหาวิทยาลัย</option>
