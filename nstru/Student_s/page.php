                        ...
                        <div class="row g-3">
                            <div class="col">
                                ...
                                <div class="form-check">
                                    <label type="text" for="formGroupExampleInput" class="form-label">มหาวิทยาลัยราชภัฏนครศรีธรรมราช</label>
                        ...
                        <div class="row g-3">
                            <div class="col">
                                ...
                                <select class="form-select a2" name="a2" aria-label="Default select example" id="a2">
                                    ...
                                    <option value="4.คณะวิทยาศาสตร์และเทคโนโลยี">4. คณะวิทยาศาสตร์และเทคโนโลยี</option>
