                        ...
                        <div class="row g-3">
                            <div class="col">
                                ...
                                <select class="form-select a2" name="a2" aria-label="Default select example" id="a2">
                                    ...
                                    <option value="7.ำนักส่งเสริมวิชาการและงานทะเบียน">7. ำนักส่งเสริมวิชาการและงานทะเบียน</option>
                                    <option value="8.สำนักวิทยบริการและเทคโนโลยีสารสนเทศ">8. สำนักวิทยบริการและเทคโนโลยีสารสนเทศ</option>
                                    <option value="9.สำนักคอมพิวเตอร์">9. สำนักคอมพิวเตอร์</option>
                                    <option value="10.สำนักศิลปะและวัฒนธรรม ">10. สำนักศิลปะและวัฒนธรรม </option>
                                    <option value="11.สถาบันวิจัยและพัฒนา">11. สถาบันวิจัยและพัฒนา</option>
                                    <option value="12.ศูนย์งานในมหาวิทยาลัย">12. ศูนย์งานในมหาวิทยาลัย</option>
