$(".btnsub").submit(function () {
  ...
  if ($(".q6:checked").length == "") {
    alert("6.โดยปกติท่านกินผัก/ผลไม้ บ่อยเพียงใด");
    $("#checkq6-1").focus();
    return false;
  }
  ...
  if ($(".q8:checked").length == "") {
    alert(
      "8.ปัจจุบันท่านเห็นด้วยกับประโยคนี้หรือไม่ “การบริโภค กระท่อมเป็นเรื่องที่ยอมรับได้”"
    );
    $("#checkq8-1").focus();
    return false;
  }
  if ($(".q9:checked").length == "") {
    alert("9.โดยปกติท่านออกกำลังกายเฉลี่ยสัปดาห์ละกี่วัน");
    $("#checkq9-1").focus();
    return false;
  }
  if ($(".q10:checked").length == "") {
    alert(
      "10.ปัจจุบันท่านดื่มเครื่องดื่มที่มีแอลกอฮอล์ เช่น เหล้า เบียร์ ไวน์ หรือสุราพื้นบ้านหรือไม่"
    );
    $("#checkq10-1").focus();
    return false;
  }
