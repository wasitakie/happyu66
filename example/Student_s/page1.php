    ...
    <div class="container manu">
        <div class="col-md-12">
            ...
            <form action="page1Insert.php" method="post" class="btnsub">
                ...
                <div class="box">
                    <div class="question">
                        <label for="formGroupExampleInput" class="form-label"><span class="textQ"> 3.
                                โดยปกติท่านกินอาหารที่มีรสหวานจัด เช่น ช็อกโกแลต โดนัท ขนมเค้ก น้ำอัดลม ฯลฯ
                ...
                <div class="box">
                    <div class="question">
                        <label for="formGroupExampleInput" class="form-label"><span class="textQ"> 6.
                                โดยปกติท่านกินผัก/ผลไม้ บ่อยเพียงใด</span></label>
                        <div class="form-check">
                ...
                <div class="box">
                    <div class="question">
                        <label for="formGroupExampleInput" class="form-label"><span class="textQ"> 7.
                                ปัจจุบันท่านสูบบุหรี่/บุหรี่ไฟฟ้า/ใบจาก/ยาเส้น หรือไม่ </span></label>
                        <div class="form-check">
                ...
                <div class="box">
                    <div class="question">
                        <label for="formGroupExampleInput" class="form-label"><span class="textQ"> 8.
                                ปัจจุบันท่านเห็นด้วยกับประโยคนี้หรือไม่ “การบริโภค กระท่อม
                                เป็นเรื่องที่ยอมรับได้”</span></label>
                        <div class="form-check">
                ...
                <div class="box">
                    <div class="question">
                        <label for="formGroupExampleInput" class="form-label"><span class="textQ"> 9.
                                โดยปกติท่านออกกำลังกาย
                                เฉลี่ยสัปดาห์ละกี่วัน </span></label>
                        <div class="form-check">
                ...
                <div class="box">
                    <div class="question">
                        <label for="formGroupExampleInput" class="form-label"><span class="textQ"> 10.
                                ปัจจุบันท่านดื่มเครื่องดื่มที่มีแอลกอฮอล์ เช่น เหล้า เบียร์ ไวน์
            ...
            <script src="../jsStudent_s/jspage1.js"></script>
