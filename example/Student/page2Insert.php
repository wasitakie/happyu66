...
$sumDataAll = ($sumData[$_POST["q12"]] + $sumData[$_POST["q13"]] + $sumData[$_POST["q14"]] + $sumData[$_POST["q15"]] + $sumData[$_POST["q16"]] + $sumData[$_POST["q17"]] + $sumData[$_POST["q18"]] + $sumData[$_POST["q19"]] + $sumData[$_POST["q20"]] + $sumData[$_POST["q21"]]) / 10;
