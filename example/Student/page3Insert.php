...
session_start();
//6//
$page3_array = array("", $_POST["q22"], $_POST["q23"], $_POST["q24"], $_POST["q25"], $_POST["q26"], $_POST["cv3"]);

$sumData = array('', '0', '25', '50', '75', '100');

$sumDataAll = ($sumData[$_POST["q22"]] + $sumData[$_POST["q23"]] + $sumData[$_POST["q24"]] + $sumData[$_POST["q25"]] + $sumData[$_POST["q26"]]) / 5;
