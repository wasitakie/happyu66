...
session_start();
//7//
$page4_array = array("", $_POST["q27"], $_POST["q28"], $_POST["q29"], $_POST["q30"], $_POST["q31"], $_POST["q32"], $_POST["cv4"]);

$sumData = array('', '0', '25', '50', '75', '100');

$sumDataAll = ($sumData[$_POST["q27"]] + $sumData[$_POST["q28"]] + $sumData[$_POST["q29"]] + $sumData[$_POST["q30"]] + $sumData[$_POST["q31"]] + $sumData[$_POST["q32"]]) / 6;

$_SESSION["sumNum4"] = $sumDataAll;
$_SESSION["page4_array"] = $page4_array;
        ...
        <div class="row">
            ...
            <div class="col-md-6 animate__animated animate__zoomInUp">
                <div class="mainS font">
                    ...
                    <hr>
                    <a name="" id="" class="btn btn-primary btn-block" href="page5.php" role="button">ทำแบบสำรวจในส่วนต่อไป</a>
                </div>
            </div>
            <div class="col-md-3"></div>
        </div>
