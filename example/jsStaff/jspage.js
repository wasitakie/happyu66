...
$(".btnsub").submit(function () {
  ...
  if ($(".q2-13:checked").length == "" && $(".q2-13t:checked").length == "") {
    alert("2.13 สถานภาพการจ้างงาน");
    $("#checkq2-13-1").focus();
    return false;
  }
  if ($(".q2-13t:checked").length != "" && $("#q2-13t").val() == "") {
    alert("2.13 ระบุ....");
    $("#q2-13t").focus();
    return false;
  }
