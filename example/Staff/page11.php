    ...
    <div class="container manu">
        <div class="col-md-12">
            ...
            <form action="page11Insert.php" method="post" class="btnsub">
                <div class="box">
                    <div class="question">
                        <label for="formGroupExampleInput" class="form-label"><span class="textQ">67.
                ...
                <div class="box">
                    <div class="question">
                        <label for="formGroupExampleInput" class="form-label"><span class="textQ">69. ท่านรู้สึกว่า
                ...
                <div class="box">
                    <div class="question">
                        <label for="formGroupExampleInput" class="form-label"><span class="textQ">70. หน่วยงานของท่าน
                ...
                <div class="box">
                    <div class="question">
                        <label for="formGroupExampleInput" class="form-label"><span class="textQ">71.
                ...
                <div class="box">
                    <div class="question">
                        <label for="customRange3" class="form-label"><span class="textQ">
                                72. ปัจจุบัน ความสุข ของท่านอยู่ในระดับใด ขอให้ท่านกากบาท X ลงบนเส้นด้านล่างโดยคะแนนจะเรียงจากน้อยไป
                                หามากเริ่มจาก 0 หมายถึง ไม่มีความสุขเลย ไปจนถึง 10 หมายถึง มีความสุขที่สุด
                            </span></label>
                        <p>
                            <label for="amount">ผลคะแนนที่ท่านเลือก:</label>
                            <input type="text" id="amount" readonly style="border:0; color:#f6931f; font-weight:bold;" name="q72">
                        </p>
                ...
                <div class="box">
                    <div class="question">
                        <label for="customRange3" class="form-label"><span class="textQ">
                                73. ปัจจุบันสถานการณ์การแพร่ระบาดโควิด-19 (COVID-19) ส่งผลกระทบต่อชีวิตความเป็นอยู่ของท่านในระดับใด โปรด กากบาท X ลงบนเส้นด้านล่าง โดยคะแนนเริ่มจาก 0 หมายถึง ไม่ส่งผลกระทบต่อชีวิตความเป็นอยู่เลย ไปจนถึง 10 หมายถึง ส่งผลกระทบต่อชีวิตความเป็นอยู่มากที่สุด </span></label>
                        <p>
                            <label for="amount1">ผลคะแนนที่ท่านเลือก:</label>
                            <input type="text" id="amount1" readonly style="border:0; color:#f6931f; font-weight:bold;" name="q73">
                        </p>
