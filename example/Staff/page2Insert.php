...
$page2_array = array("", $_POST["q10"], $_POST["q11"], $_POST["q12"], $_POST["q13"], $_POST["q14"], $_POST["cv2"]);

$sumData = array('', '0', '25', '50', '75', '100');

$sumDataAll = ($sumData[$_POST["q10"]] + $sumData[$_POST["q11"]] + $sumData[$_POST["q12"]] + $sumData[$_POST["q13"]] + $sumData[$_POST["q14"]]) / 5;

$_SESSION["sumNum2"] = $sumDataAll;
$_SESSION["page2_array"] = $page2_array;

// foreach ($_SESSION["page2_array"] as $page2) {
//     echo $page2 . "<br>";
// }
        ...
        <div class="row">
            ...
            <div class="col-md-6 animate__animated animate__zoomInUp">
                <div class="mainS font">
                    ...
                    <hr>
                    <a name="" id="" class="btn btn-primary btn-block" href="page3.php" role="button">ทำแบบสำรวจในส่วนต่อไป</a>
                </div>
            </div>
            <div class="col-md-3"></div>
        </div>
