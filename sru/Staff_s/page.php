                        ...
                        <div class="row g-3">
                            <div class="col">
                                ...
                                <select class="form-select a2" name="a2" aria-label="Default select example" id="a2">
                                    ...
                                    <option value="5.คณะพยาบาลศาสตร์">5. คณะพยาบาลศาสตร์</option>
                                    <option value="6.คณะนิติศาสตร์">6. คณะนิติศาสตร์</option>
                                    <option value="7.วิทยาลัยนานาชาติการท่องเที่ยว">7. วิทยาลัยนานาชาติการท่องเที่ยว</option>
                                    <option value="8.บัณฑิตวิทยาลัย">8. บัณฑิตวิทยาลัย</option>
                                    <option value="9.สำนักงานอธิการบดี">9. สำนักงานอธิการบดี</option>
                                    <option value="10.สำนักส่งเสริมวิชาการและงานทะเบียน">10. สำนักส่งเสริมวิชาการและงานทะเบียน</option>
                                    <option value="11.สำนักวิทยบริการและเทคโนโลยีสารสนเทศ">11. สำนักวิทยบริการและเทคโนโลยีสารสนเทศ</option>
                                    <option value="12.สำนักศิลปะและวัฒนธรรม">12. สำนักศิลปะและวัฒนธรรม</option>
                                    <option value="13.สำนักจัดการทรัพย์สิน">13. สำนักจัดการทรัพย์สิน</option>
                                    <option value="14.สถาบันวิจัยและพัฒนา">14. สถาบันวิจัยและพัฒนา</option>
                                    <option value="15.สำนักงานสภามหาวิทยาลัย">15. สำนักงานสภามหาวิทยาลัย</option>
                                    <option value="16.หน่วยตรวจสอบภายใน">16. หน่วยตรวจสอบภายใน</option>
                                </select>
