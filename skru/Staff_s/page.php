                        ...
                        <div class="row g-3">
                            <div class="col">
                                ...
                                <select class="form-select a2" name="a2" aria-label="Default select example" id="a2">
                                    ...
                                    <option value="7.คณะเทคโนโลยีอุตสาหกรรม">7. คณะเทคโนโลยีอุตสาหกรรม</option>
                                    <option value="8.คณะวิทยาลัยนวัตกรรมและการจัดการ">8. คณะวิทยาลัยนวัตกรรมและการจัดการ</option>
                                    ...
                                    <option value="13.ศูนย์งานในมหาวิทยาลัย">13. ศูนย์งานในมหาวิทยาลัย</option>
                                    <option value="14.คณะอื่นๆในมหาวิทยาลัย">14. คณะอื่น ๆ ในมหาวิทยาลัย</option>
                                </select>
